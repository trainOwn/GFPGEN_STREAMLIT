...
st.title("RESTOR FACES USING GAN")
...
if image_file is not None:
    ...
    in_pil = Image.open(image_file)
    nimg = np.array(in_pil)
    ocvim = nimg[:, :, ::-1].copy()
    input_img = ocvim
    ...
    with st.spinner('Your clear face is getting read, please wait ...'):
